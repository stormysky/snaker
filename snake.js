...
snake.control.addEventListener(
	...
	function(event){
		...
		if(snake.controlText.style.opacity != "0"){
			snake.control.style.background = "url('./image/starton.png') no-repeat";
			snake.controlText.style.opacity = "0";
			snake.Start();
		}
		else{
			snake.control.style.background = "url('./image/pauseon.png') no-repeat";
...
snake.control.addEventListener(
	...
	function(event){
		...
		var tips = snake.controlText.innerHTML;
		if(snake.controlText.style.opacity == "0"){
			snake.control.style.background = "url('./image/pause.png') no-repeat";
		}
		else{
			snake.control.style.background = "url('./image/start.png') no-repeat";
		}
